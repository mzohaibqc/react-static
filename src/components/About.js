...
I also love git and I've given some talks on git in QC Technologies, Lahore.</p>
        ...
        <div className="card-action" >
          <a href="https://www.facebook.com/zohaibijaz786" target="_blank"><i className="small zmdi zmdi-facebook indigo-text text-darken-1"></i></a>
          <a href="https://github.com/mzohaibqc" target="_blank"><i className="small zmdi zmdi-github black-text"></i></a>
          <a href="https://www.linkedin.com/in/zohaib-ijaz-7a657a58?trk=hp-identity-name" target="_blank"><i className="small zmdi zmdi-linkedin indigo-text text-lighten-1"></i></a>
        </div>
      </div>
    </div>
  </div>
